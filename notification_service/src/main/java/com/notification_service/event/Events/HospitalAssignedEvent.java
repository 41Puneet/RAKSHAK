...
public class HospitalAssignedEvent {
...
public HospitalAssignedEvent(){

}
public HospitalAssignedEvent(UUID emergencyId,UUID responderId,EmergencyType emergencyType,Priority priority,String hospitalName,String hospitalAddress,Double latitude,Double longitude,Double distanceInKm,Double etaInMinutes){
