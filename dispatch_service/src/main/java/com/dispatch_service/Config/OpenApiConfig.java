...
@Configuration public class OpenApiConfig { @Bean public OpenAPI dispatchApi() { return new OpenAPI().info(new Info().title("RAKSHAK Dispatch API").version("1.0.0").description("Responder selection and dispatch assignment API")); } }
